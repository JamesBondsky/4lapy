...
class PutUserCartResponse
{
     ...
     *
     * @return PutUserCartResponse
     */
    public function setCartParam(OrderParameter $cartParam): PutUserCartResponse
    {
     ...
     * @return PutUserCartResponse
     */
    public function setCartCalc(OrderCalculate $cartCalc): PutUserCartResponse
    {
