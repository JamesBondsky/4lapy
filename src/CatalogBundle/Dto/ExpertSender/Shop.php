...
class Shop
{
     ...
     * @Serializer\Type("ArrayCollection<FourPaws\CatalogBundle\Dto\ExpertSender\Currency>")
     *
     ...
     * @Serializer\Type("ArrayCollection<FourPaws\CatalogBundle\Dto\ExpertSender\Category>")
     *
     ...
     * @Serializer\Type("ArrayCollection<FourPaws\CatalogBundle\Dto\ExpertSender\Offer>")
     *
     ...
     * @Serializer\Type("ArrayCollection<FourPaws\CatalogBundle\Dto\ExpertSender\Promo>")
     * @Serializer\SkipWhenEmpty()
     *
