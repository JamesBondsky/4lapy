...
class OrderDeliveryValidator extends ConstraintValidator
{
    ...
    public function validate($entity, Constraint $constraint)
    {
        ...
        if (abs($dateDiff) > static::MAX_DATE_DIFF) {
            $this->context->buildViolation($constraint->deliveryDateExpiredMessage)
        ...
        } elseif ($this->deliveryService->isDostavistaDelivery($delivery) || $this->deliveryService->isExpressDelivery($delivery) || $this->deliveryService->isDobrolapDelivery($delivery)) {
        } else {
