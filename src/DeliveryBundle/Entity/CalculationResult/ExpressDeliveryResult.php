...
class ExpressDeliveryResult extends BaseResult implements DeliveryResultInterface
{
    ...
    private function LatLngDist($p, $q)
    {
        ...
        $dLat = (($q[0] - $p[0]) * M_PI / 180);
        $dLon = (($q[1] - $p[1]) * M_PI / 180);
        $a = sin($dLat / 2) * sin($dLat / 2) +
            cos($p[0] * M_PI / 180) * cos($q[0] * M_PI / 180) *
    ...
    /**
     * @param $freePriceFrom
     * @return ExpressDeliveryResult
     */
    protected function setFreePriceFrom($freePriceFrom): ExpressDeliveryResult
    {
     ...
     */
    protected function getFreePriceFrom(): DostavistaDeliveryResult
    {
