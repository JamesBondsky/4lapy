<div class="b-container b-container--confidentiality">
	<div class="b-confidentiality-page">
		...
		<div class="b-confidentiality-page__date">
			г.Жуковский «23» февраля 2017 года
		</div>
	</div>
</div>
<div class="b-container">
	<div class="b-confidentiality-page">
		...
		<p>
			1.1. Настоящее Пользовательское соглашение (далее – Соглашение) относится к сайту Интернет-магазина «Четыре Лапы», расположенному по адресу <a href="https://4lapy.ru/">https://4lapy.ru/</a>.
		</p>
		<p>
			1.2. Сайт Интернет-магазина «Четыре Лапы» (далее – Сайт) является собственностью ООО «ЗУМ+».
		</p>
		<p>
			1.3. Настоящее Соглашение регулирует отношения между Администрацией сайта Интернет- магазина «Четыре Лапы» (далее – Администрация сайта) и Пользователем данного Сайта.
		</p>
		<p>
			1.4. Условия настоящего Пользовательского соглашения рассматриваются Администрацией Сайта как публичная оферта в соответствии со ст. 436 Гражданского кодекса Российской Федерации, Пользовательское соглашение вступает в силу с момента выражения Вами согласия с его условиями путем регистрации.
		</p>
		<p>
			1.5. Администрация сайта оставляет за собой право в любое время изменять, добавлять или удалять пункты настоящего Соглашения без уведомления Пользователя.
		</p>
		<p>
			1.6. Продолжение использования Сайта Пользователем означает принятие Соглашения и изменений, внесенных в настоящее Соглашение.
		</p>
		<p>
			1.7. Пользователь несет персональную ответственность за проверку настоящего Соглашения на наличие изменений в нем.
		</p>
		<p>
			1.8. Действующая редакция Соглашения размещается на странице по адресу <a href="https://4lapy.ru/">https://4lapy.ru/</a>.
		</p>
		<p class="b-title b-title--h2">
		...
		<p>
			2.1.1 «Четыре Лапы» – Интернет-магазин, расположенный на доменном имени www. <a href="https://4lapy.ru/">https://4lapy.ru/</a>, осуществляющий свою деятельность посредством Интернет-ресурса и сопутствующих ему сервисов.
		</p>
		<p>
			2.1.2. Интернет-магазин – сайт, содержащий информацию о Товарах, Продавце, позволяющий осуществить выбор, заказ и (или) приобретение Товара. 2.1.3. Администрация сайта Интернет-магазина – уполномоченные сотрудники на управления Сайтом, действующие от имени ООО «ЗУМ+».
		</p>
		<p>
		...
		<p>
			3.2. Доступ к Интернет-магазину предоставляется на безвозмездной основе.
		</p>
		<p>
		...
		<p>
			4.3.3. Не распространять с использованием Сайта любую конфиденциальную и охраняемую законодательством Российской Федерации информацию о физических либо юридических лицах. Избегать любых действий, в результате которых может быть нарушена конфиденциальность охраняемой законодательством Российской Федерации информации.
		</p>
		<p>
			4.3.4. Не использовать Сайт для распространения информации рекламного характера.
		</p>
		<p>
			4.3.5. Пользоваться Сайтом исключительно в целях и порядке, предусмотренных Соглашением и не запрещенных законодательством Российской Федерации
		</p>
		<p>
			4.4. Пользователю запрещается:
		</p>
		<p>
			4.4.1. Использовать любые устройства, программы, процедуры, алгоритмы и методы, автоматические устройства или эквивалентные ручные процессы для доступа, приобретения, копирования или отслеживания содержания Сайта Интернет-магазина;
		</p>
		<p>
		...
		<p>
			5.7. Администрация сайта обладает правом в одностороннем порядке аннулировать учетную запись Пользователя, если она не использовалась более 6 (шесть) календарных месяцев подряд без уведомления Пользователя.
		</p>
		<p>
		...
		<p>
			7.2. Администрация сайта имеет право раскрыть любую информацию о Пользователе, которую посчитает необходимой для выполнения положений действующего законодательства или судебных решений, обеспечения выполнения условий настоящего Соглашения, защиты прав или безопасности ООО «ЗУМ+», его партнеров, Пользователей.
		</p>
		<p>
		...
		<p>
			7.6. Администрация сайта вправе без предварительного уведомления Пользователя раскрыть любую информацию о Пользователе, которая необходима для выполнения ей своих обязательств перед Пользователем по покупке и доставке Товара своим партнерам, имеющим отношение к выполнению указанных обязательств.
		</p>
		<p class="b-title b-title--h2">
			8. РАЗРЕШЕНИЕ СПОРОВ
		</p>
		...
		<p>
			9.3. Политика конфиденциальности, опубликованная на Сайте, является частью настоящего Пользовательского соглашения.
		</p>
 <i>Обновлено «10» декабря 2019 г</i>
	</div>
</div>
<div class="b-preloader b-preloader--fixed">
	<div class="b-preloader__spinner">
 <img alt="spinner" src="/static/build/images/inhtml/spinner.svg" class="b-preloader__image" title="">
	</div>
</div>
<br>