        ...
        <div class="b-container">
            <div class="main-banner-blackfriday__info">
                ...
                <div class="timer-blackfriday">
                    ...
                    <?php /*<div class="timer-blackfriday__title">До&nbsp;завершения <span class="hide-mobile">акции</span> осталось:</div>*/ ?>
                    ...
                    <a class="b-common-item__link" target="_blank" href="/catalog/koshki/gigiena-i-kosmetika-koshki/" title="Средства гигиены и косметика">
                        <span class="b-common-item__image-wrap b-common-item__image-wrap--catalog">
                            <img src="/resize/180x180/upload/iblock/fd8/fd8e8ee58e432edfb9d7c36efbde41f3.jpg"
                                 ...
                                 alt="Средства гигиены и косметика"
                                 title="Средства гигиены и косметика">
                        </span>
                    ...
                    <a class="b-common-item__link" target="_blank" href="/catalog/koshki/korrektsiya-povedeniya-koshki/" title="Средства коррекции поведения">
                        <span class="b-common-item__image-wrap b-common-item__image-wrap--catalog">
                            <img src="/resize/180x180/upload/iblock/2cc/2cc9bfa5399f844135baac5b02fdcf18.jpg"
                                 class="b-common-item__image b-common-item__image--catalog"
                                 alt="Средства коррекции поведения"
                                 title="Средства коррекции поведения">
                        </span>
                        <span class="b-common-item__description-wrap b-common-item__description-wrap--catalog">
                            <span class="b-clipped-text b-clipped-text--catalog">
                                <span>Средства коррекции поведения</span>
                            </span>
                        </span>
                    </a>
                </div>
                    ...
                    <a class="b-common-item__link" target="_blank" href="/catalog/koshki/sredstva-ot-zapakha-i-pyaten-koshki/" title="Средства от запаха и пятен">
                        <span class="b-common-item__image-wrap b-common-item__image-wrap--catalog">
                            <img src="/resize/180x180/upload/iblock/a7f/a7f2432a770554c35a52fbca95e083a7.jpg"
                                 class="b-common-item__image b-common-item__image--catalog"
                                 alt="Средства от запаха и пятен"
                                 title="Средства от запаха и пятен">
                        </span>
                        <span class="b-common-item__description-wrap b-common-item__description-wrap--catalog">
                            <span class="b-clipped-text b-clipped-text--catalog">
                                <span>Средства от запаха и пятен</span>
                            </span>
                        </span>
                    </a>
                </div>
                ...
                <div class="item">
                    <div class="banner-blackfriday">
                        ...
                        <div class="banner-blackfriday__content">
                            ...
                            <a href="/catalog/ryby/" target="_blank" class="banner-blackfriday__btn">Посмотреть все</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="banner-blackfriday">
                        ...
                        <div class="banner-blackfriday__content">
                            ...
                            <a href="/catalog/ptitsy/" target="_blank" class="banner-blackfriday__btn">Посмотреть все</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="banner-blackfriday">
                        ...
                        <div class="banner-blackfriday__content">
                            ...
                            <a href="/catalog/gryzuny-i-khorki/" target="_blank" class="banner-blackfriday__btn">Посмотреть все</a>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="banner-blackfriday">
                        ...
                        <div class="banner-blackfriday__content">
                            ...
                            <a href="/catalog/reptilii/" target="_blank" class="banner-blackfriday__btn">Посмотреть все</a>
                        </div>
                    </div>
                </div>
            </div>
