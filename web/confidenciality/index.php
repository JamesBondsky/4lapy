...
<div class="b-container">
    ...
    <p>
        2.3. Настоящая Политика конфиденциальности применяется исключительно к сайту Интернет-магазина  «Четыре Лапы».
    ...
    <p>
        7.3. Все предложения или вопросы по настоящей Политике конфиденциальности следует сообщать в раздел <a href="/feedback/" target="_blank" class="b-link">Обратная связь</a> Интернет-магазина «Четыре Лапы»
    </p>
    <p>
        7.4. Действующая Политика конфиденциальности размещена на странице по адресу
        <a href="https://www.4lapy.ru/confidenciality/">https://www.4lapy.ru/confidenciality/</a>
    </p>
<?php
