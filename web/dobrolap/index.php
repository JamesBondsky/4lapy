			...
			<div class="container">
				<div class="row justify-content-center pb-5">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <h5 class="mb-4">«Четыре Лапы» объединяет всех, кто не равнодушен к питомцам без семьи, с целью помочь животным найти родителей и поддержать временно бездомных друзей.</h5>
                        <hr />
