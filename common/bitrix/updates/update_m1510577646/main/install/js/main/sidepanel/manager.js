...
BX.SidePanel.Manager = function(options)
{
	...
	BX.addCustomEvent("SidePanel:postMessage", this.handlePostMessage.bind(this));
	BX.addCustomEvent("SidePanel:postMessageAll", this.handlePostMessageAll.bind(this));
	BX.addCustomEvent("SidePanel:postMessageTop", this.handlePostMessageTop.bind(this));
...
BX.SidePanel.Manager.prototype =
{
	 ...
	 * @param {object} data
	 */
	handlePostMessage: function(source, eventId, data)
	{
	...
	{
		this.handlePostMessage(source, "", data);
	},
	 ...
	 * @param {object} data
	 */
	handlePostMessageAll: function(source, eventId, data)
	{
		var sender = this.getSliderFromSource(source);
		if (!sender)
		{
	 ...
	 * @param {object} data
	 */
	handlePostMessageTop: function(source, eventId, data)
	{
		var sender = this.getSliderFromSource(source);
		if (!sender)
		{
