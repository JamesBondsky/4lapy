<?php
$MESS['BENDERSAY_EXPORTIMPORT_TITLE'] = 'Импорт данных Highload-блока из JSON';
...
$MESS['BENDERSAY_EXPORTIMPORT_INFO'] = 'В параметре указывается поле из импортируемого файла,'
