...
$userService = $container->get(UserCitySelectInterface::class);
try {
...
<script type="text/javascript">
    console.log('📊exponea.initialize'); //TODO exponea comment
	exponea.initialize({
        ...
        "track": {
            ...
            if (isset($cityName) && $cityName) {
                ?>
                    ...
                    "default_properties": {
                        "geo_city": "<?= $cityName ?>"
                        <?php // "geo_region": "" //FIXME exponea Нужен geo_region в exponea.initialize? Чтобы узнать регион, наверное, нужно делать дополнительные запросы ?>
                    }
                <?php
            }
            ?>
