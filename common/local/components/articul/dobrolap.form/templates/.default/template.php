            ...
            <div class="col-md-6">
                <div class="row justify-content-center">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <hr />
                        <h5 class="mb-4">Для активации <nobr>фан-бонуса</nobr> зарегистрируйте промокод.</h5>
                        <h5 class="mb-4">Промокодами на&nbsp;скидку вы&nbsp;можете воспользоваться при&nbsp;оформлении заказа на&nbsp;сайте,
                        в&nbsp;мобильном приложении или&nbsp;на&nbsp;кассе в&nbsp;магазине. Регистрировать их&nbsp;не&nbsp;требуется.</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
