...
<div class="b-kopilka">
                    ...
                    <div class="b-sale-coupon-kopilka__top">
                        ...
                        <div class="b-sale-coupon-kopilka__barcode">
                            <div class="b-sale-coupon-kopilka__barcode-img">
                                <img src="/static/build/images/content/barcode-kopilka.png" alt="" /><? //TODO generate barcode (look github repo) ?>
                            </div>
    ...
    <div class="b-kopilka__info">
        <h3>Условия акции</h3>
        <p>За каждые <?= $arParams['MARK_RATE'] ?> рублей в чеке получайте:</p>
        <ul>
            <li><?= $arParams['MARKS_PER_RATE_VETAPTEKA'] ?> марки на товары из категории “Ветаптека”;</li><? //TODO окончания ?>
            <li><?= $arParams['MARKS_PER_RATE'] ?> марку на все остальные товары. Марки будут начислены после завершения заказа.</li><? //TODO окончания ?>
        </ul>
        <p>Меняйте марки на купоны на скидку:</p>
        <p><b><?= $arParams['COUPON_LEVELS'][1]['MARKS_TO_LEVEL_UP_FROM_BOTTOM'] ?> марок</b> - <span class="orange">скидка <?= $arParams['COUPON_LEVELS'][1]['DISCOUNT'] ?>%</span>;</p>
        <p><b><?= $arParams['COUPON_LEVELS'][2]['MARKS_TO_LEVEL_UP_FROM_BOTTOM'] ?> марок</b> - <span class="orange">скидка <?= $arParams['COUPON_LEVELS'][2]['DISCOUNT'] ?>%</span>;</p>
        <p><b><?= $arParams['COUPON_LEVELS'][3]['MARKS_TO_LEVEL_UP_FROM_BOTTOM'] ?> марок</b> - <span class="orange">скидка <?= $arParams['COUPON_LEVELS'][3]['DISCOUNT'] ?>%</span>.</p>
