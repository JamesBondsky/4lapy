    ...
    <div class="b-kopilka__info">
        ...
        <ol>
            ...
            <li>Как только Вы&nbsp;накопите необходимое количество марок для получения скидки, рядом с&nbsp;марками появится кнопка &laquo;Обменять марки&raquo;, при нажатии на&nbsp;нее Вы&nbsp;получите <nobr>промо-код</nobr> на&nbsp;скидку на&nbsp;товары, участвующие в&nbsp;акции.<br/>
                ...
                <ul>
                    <li><b><?= $arParams['COUPON_LEVELS'][1]['MARKS_TO_LEVEL_UP_FROM_BOTTOM'] ?>&nbsp;марок</b>&nbsp;&mdash; <span class="orange">скидка <?= $arParams['COUPON_LEVELS'][1]['DISCOUNT'] ?>%</span> на&nbsp;товары для путешествий с&nbsp;питомцем;</li>
                    <li><b><?= $arParams['COUPON_LEVELS'][2]['MARKS_TO_LEVEL_UP_FROM_BOTTOM'] ?>&nbsp;марок</b>&nbsp;&mdash; <span class="orange">скидка <?= $arParams['COUPON_LEVELS'][2]['DISCOUNT'] ?>%</span> на&nbsp;товары для путешествий с&nbsp;питомцем;</li>
