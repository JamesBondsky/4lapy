...
<div class="b-registration__content b-registration__content--moiety b-registration__content--step b-cart-combination">
    ...
    <form class="b-registration__form">
        <input type="button" name="confirm_yes" value="Да" class="b-button b-button--social b-button--full-width js-ajax-item" data-url="<?= $ajaxUrl ?>"
               data-action="unionBasket" data-backurl="<?= $backUrl ?>" data-need_add_phone="<?= $needAddPhone ?>">
        <input type="button" name="confirm_no" value="Нет" class="b-button b-button--social b-button--full-width js-ajax-item" data-url="<?= $ajaxUrl ?>"
