                            ...
                            <ul class="b-tab-title__list b-tab-title__list--referal">
                                    ...
                                    <a class="b-tab-title__link js-referal-link"
                                       ...
                                       data-tab="all">
                                        <span class="b-tab-title__text">
                                            Все
                                            <span class="b-tab-title__number">(<?=$arResult['COUNT']?>)</span>
                                        </span>
                                    </a>
                                </li>
                                <li class="b-tab-title__item js-tab-referal-item">
                                    <a class="b-tab-title__link js-referal-link"
                                       href="javascript:void(0);"
                                       title="Активные "
                                       data-tab="active-referal">
                                        <span class="b-tab-title__text">
                                            Активные
                                            <span class="b-tab-title__number">(<?=$arResult['COUNT_ACTIVE']?>)</span>
                                        </span>
                                    </a>
                                </li>
                                <li class="b-tab-title__item js-tab-referal-item">
                                    <a class="b-tab-title__link js-referal-link"
                                       ...
                                       data-tab="moderate">
                                        <span class="b-tab-title__text">
                                            На модерации
                                            <span class="b-tab-title__number">(<?=$arResult['COUNT_MODERATE']?>)</span>
                                        </span>
                                    </a>
                                </li>
                            </ul>
                                ...
                                <div class="b-account-referal-item__wrapper">
                                    ...
                                    <div class="b-account-referal-item__column">
                                        <div class="b-account-referal-item__bonus">Начислено бонусов
                                            <span class="b-account-referal-item__number"><span><?=$item->getBonus()?></span><span
                                        ...
                                        <?}else{?>
                                        <div class="b-account-referal-item__status b-account-referal-item__status--<?= !$item->isEndActiveDate() ? 'active' : 'not-active'?>">
                                            <?= !$item->isEndActiveDate() ? 'Активна до ' : 'Неактивна c '?>"><span><?=$item->getFormatedActiveDate()?></span>
                                        </div>
                                        <?}?>
                                    </div>
                                </div>
