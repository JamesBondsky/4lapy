...
?>
<section class="b-subscribe-delivery-cart <?=$mobile ? 'mobile' : 'desktop'?>">
    <div class="b-subscribe-delivery-cart__anchor" data-subscribe-delivery-cart="<?=$mobile ? 'mobile' : 'desktop'?>"></div>
