...
foreach ($delivery['INTERVAL_DAYS'] as $deliveryIntervalDay) {
    $deliveryTime = $deliveryIntervalDay->getTimeTo();
    break;
}
...
*/ ?>
    <div class="b-delivery__info">
        ...
        <div class="b-delivery__info-item">
            ...
            <?php } else { ?>
                <div class="b-delivery__info-icon"><img src="/static/build/images/inhtml/delivery-icon-02_region.png">
                </div>
                <div class="b-delivery__info-text"><strong>В тот же день</strong><span>при заказе до <?= $deliveryTime ?>.00</span></div>
            <? } ?>
        </div>
        <div class="b-delivery__info-item">
