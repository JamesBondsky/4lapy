    ...
    <div class="b-comment-block">
        ...
        <div class="b-comment-block__auth--block js-comments-auth-block-<?= $uniqueCommentString ?>"
            ...
            <p class="b-comment-block__auth">
                <a href="#" class="js-open-popup" data-popup-id="authorization">Авторизуйтесь</a> , чтобы написать
                комментарий.
            </p>
        </div>
        <?php /** @noinspection PhpUnhandledExceptionInspection */
                ...
                <div class="b-rate-block__right-side">
                    ...
                    if ($arResult['COUNT_COMMENTS'] > 0) { ?>
                        <div class="b-rate-block__rate-wrapper">
                            ...
                            <span class="b-rate-block__rate-description">
                                на основе <?= $arResult['COUNT_COMMENTS'] ?> <?= WordHelper::declension($arResult['COUNT_COMMENTS'],
                                    ['отзыва', 'отзывов', 'отзывов']) ?>
                            </span>
                        </div>
                    <?php }
                    /** @noinspection PhpUnhandledExceptionInspection */
