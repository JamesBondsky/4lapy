...
class CVKontakteOAuthInterface extends CSocServOAuthTransport
{
	...
	public function __construct($appID = false, $appSecret = false, $code = false)
	{
		...
		if ($appSecret === false)
		{
			...
			$appSecret = 'DqVBDXbSFY1J8WnVkcKZ';
		}
	...
	public function GetCurrentUser()
	{
		...
		$result = $h->get(self::CONTACTS_URL . '?v=5.8&fields=uid,first_name,last_name,nickname,screen_name,sex,bdate,city,country,timezone,photo,photo_medium,photo_max_orig,photo_rec,email,contacts&access_token=' . urlencode($this->access_token));
