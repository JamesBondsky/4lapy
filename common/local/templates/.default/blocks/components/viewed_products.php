...
/** @global $APPLICATION */
/** @var array $arParams */
// todo включить после черной пятницы и разобраться почему много запросов
...
//        IblockUtils::getIblockId($arParams['PRODUCTS_IBLOCK_TYPE'], $arParams['PRODUCTS_IBLOCK_CODE']);
//    $arParams['OFFERS_IBLOCK_TYPE'] = IblockType::CATALOG;
//    $arParams['OFFERS_IBLOCK_CODE'] = IblockCode::OFFERS;
//    $arParams['OFFERS_IBLOCK_ID'] =git
//        IblockUtils::getIblockId($arParams['OFFERS_IBLOCK_TYPE'], $arParams['OFFERS_IBLOCK_CODE']);
//
//    $APPLICATION->IncludeComponent('bitrix:catalog.products.viewed',
//        'fp.17.0.default',
//        [
//            'WRAP_CONTAINER_BLOCK' => $arParams['WRAP_CONTAINER_BLOCK'] ?? 'N',
//            'WRAP_SECTION_BLOCK' => $arParams['WRAP_SECTION_BLOCK'] ?? 'Y',
//            'SHOW_TOP_LINE' => $arParams['SHOW_TOP_LINE'] ?? 'N',
//            'SHOW_BOTTOM_LINE' => $arParams['SHOW_BOTTOM_LINE'] ?? 'N',
//
...
//            'ACTION_VARIABLE' => 'asdajkasdjkjkleqwrjkeqrjkoerjkler',
//            //'action_cpv',
//            'PRODUCT_ID_VARIABLE' => 'xcvnmxcvmxcvmxcvmxcvkl',
//            //'id',
//            'PRICE_CODE' => [],
//            'USE_PRICE_COUNT' => 'N',
//            'SHOW_PRICE_COUNT' => '1',
