...
$arParams['WRAP_SECTION_BLOCK'] = $arParams['WRAP_SECTION_BLOCK'] ?? 'N';
...
$arParams['SHOW_BOTTOM_LINE'] = $arParams['SHOW_BOTTOM_LINE'] ?? 'N';
        ...
        <?php foreach ($arResult['PRINT_ITEMS'] as $item) { ?>
            <div class="b-viewed-product">
                <a class="b-viewed-product__link" href="<?= $item['DETAIL_PAGE_URL'] ?>" title="">
                    <span class="b-viewed-product__image-wrap">
                        <?php if ($item['IMG']) { ?>
                            <img class="b-viewed-product__image" src="<?= $item['IMG']['SRC'] ?>"
                                 alt="<?= $item['IMG']['ALT'] ?>" title="<?= $item['IMG']['TITLE'] ?>">
                        <?php } ?>
                    </span>
