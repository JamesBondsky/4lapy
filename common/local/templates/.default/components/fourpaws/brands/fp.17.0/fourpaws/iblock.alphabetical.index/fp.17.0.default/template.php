...
<div class="b-link-list js-scroll-x">
	<div class="b-link-list__wrapper"><?
		foreach($arResult['PRINT'] as $arItem) {
			...
			if($arItem['EXISTS'] === 'Y') {
				?><a class="b-link-list__link js-scroll-x<?=$sTmpAddClass?>" href="<?='#'.$arItem['ANCHOR']?>" title=""><?
					echo $arItem['CAPTION'];
				?></a><?
			} else {
				?><span class="b-link-list__link js-scroll-x<?=$sTmpAddClass?>" title=""><?
					echo $arItem['CAPTION'];
				?></span><?
			}
		}
