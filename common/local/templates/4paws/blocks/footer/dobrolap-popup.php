...
<section class="b-popup-pick-city b-popup-pick-city--authorization b-popup-pick-city--shelter js-popup-section" data-popup="dobrolap_more_info_popup" style="max-width: 740px;padding: 35px 90px 35px 40px;">
    ...
    <h5>
        ...
        <p>
            1. ВЫБЕРИ ПОДАРОК ДЛЯ ПИТОМЦА ИЗ ПРИЮТА <br />
            2. ПОЛОЖИ ЕГО В КОРЗИНУ <br />
            3. ПОЛУЧИ СЮРПРИЗ НА КАССЕ ИЛИ ПРИ ОФОРМЛЕНИИ ЗАКАЗА В ИНТЕРНЕТ-МАГАЗИНЕ <br />
            4. ЗАРЕГИСТРИРУЙ ПРОМОКОД  ФАН-БОНУСА ИЛИ ВОСПОЛЬЗУЙСЯ СКИДКОЙ ДО 30% <br />
            5. СЛЕДИ ЗА НОВОСТЯМИ, ПРИСОЕДИНЯЙСЯ В СОЦ.СЕТЯХ <br />
        </p>
    </h5>
