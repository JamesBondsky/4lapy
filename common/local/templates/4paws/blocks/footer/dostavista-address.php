...
try {
    ...
    if ($selectedCity['CODE'] === LocationService::LOCATION_CODE_MOSCOW) { ?>
        ...
        <section class="b-popup-wrapper__wrapper-modal js-popup-section" data-popup="dostavista-address" style="display: none;">
            <div class="b-registration b-registration--popup js-popup-alert-title success" data-popup="dostavista-address">
