...
<?php if ($arParams['USE_RSS'] === 'Y'): ?>
    ...
    /** @noinspection PhpUndefinedClassInspection */
    $rss_url =
        CComponentEngine::makePathFromTemplate($arResult['FOLDER'] . $arResult['URL_TEMPLATES']['rss_section'],
...
<?php if ($arParams['USE_SEARCH'] === 'Y'): ?>
    <?= GetMessage('SEARCH_LABEL') ?><?php $APPLICATION->IncludeComponent('bitrix:search.form',
                                                                          'flat',
                                                                          [
...
<?php if ($arParams['USE_FILTER'] === 'Y'): ?>
    <?php $APPLICATION->IncludeComponent('bitrix:catalog.filter',
                                         '',
                                         [
