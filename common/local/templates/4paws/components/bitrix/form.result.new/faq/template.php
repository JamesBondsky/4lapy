    ...
    <form data-url="/ajax/form/add/faq/" method="post" class="js-form-validation js-form-faq fleas-protection__form">
        ...
        <?php if ($arResult['isUseCaptcha']) {
            ...
            <div class="b-feedback-page__capcha">
                <?php try {
                    echo Application::getInstance()->getContainer()->get(ReCaptchaInterface::class)->getCaptcha('', false, '', 'vetaptekaQuestion');
        ...
        <div class="fleas-protection-block__form--info">Также Вы можете задать вопрос, позвонив по бесплатному
