...
class IblockOffersDeleteByRequestProp20180312200116 extends SprintMigrationBase
{
    protected $description = 'Удаление свойства "под заказ" из ИБ офферов';

    public const PROPERTY_CODE = 'BY_REQUEST';
