...
class Version20191220141100 extends SprintMigrationBase
{
    protected $description = 'Добавляет HL блок "Январская акция: шансы пользователей"';
    ...
    public function up()
    {
        ...
        $hlblockId = $helper->Hlblock()->addHlblockIfNotExists([
            'NAME' => 'JanuaryUserChance',
            'TABLE_NAME' => '4lapy_january_user_chance',
            'LANG' => [
                'ru' => [
                    'NAME' => 'Январская акция: шансы пользователей',
                ],
            ],
        ]);
