...
class GroomingIblockCreate20191119150547 extends \Adv\Bitrixtools\Migration\SprintMigrationBase
{
    
    protected $description = 'Создание инфоблока для лендинга Фоагманского магазина (груминг)';
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()->addIblockIfNotExists([
            ...
            'NAME'               => 'Флагманский магазин: груминг',
            'ACTIVE'             => 'Y',
            'SORT'               => '500',
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblock($helper->Iblock()->getIblockId('flagman_grooming', 'grandin'));
    }
