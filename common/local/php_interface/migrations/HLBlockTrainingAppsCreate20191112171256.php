...
class HLBlockTrainingAppsCreate20191112171256 extends SprintMigrationBase
{
    protected $description = 'Создание таблицы для хранения заявок на тренировки';
    
    const HL_BLOCK_NAME = 'TrainingApps';
    
    protected $hlBlockData = [
        'NAME'       => self::HL_BLOCK_NAME,
        'TABLE_NAME' => 'b_hlbd_training_apps',
        'LANG'       => [
            'ru' => [
                'NAME' => 'Заявки на тренировки',
            ],
        ],
    ];
        ...
        [
            ...
            'SETTINGS'          =>
                [
                    'DISPLAY'       => 'LIST',
                    'LIST_HEIGHT'   => 5,
                    'IBLOCK_ID'     => 44, //@todo don't forget to change
                    'DEFAULT_VALUE' => '',
                    'ACTIVE_FILTER' => 'N',
                ],
            'EDIT_FORM_LABEL'   =>
