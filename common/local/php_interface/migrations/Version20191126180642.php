...
class Version20191126180642 extends SprintMigrationBase
{
    protected $description = 'Добавляет инфоблок "Новый год: вопросы ответы"';
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()->addIblockIfNotExists([
            ...
            'LID' => 's1',
            'CODE' => 'ny2020_questions',
            'NAME' => 'Новый год 2020: вопросы и ответы',
            'ACTIVE' => 'Y',
            'SORT' => '500',
