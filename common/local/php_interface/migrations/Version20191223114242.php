...
class Version20191223114242 extends SprintMigrationBase
{
    protected $description = 'Добавляет инфоблок "Январь 2020: вопросы ответы"';
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()->addIblockIfNotExists([
            ...
            'LID' => 's1',
            'CODE' => 'january2020_questions',
            'NAME' => 'Январь 2020: вопросы и ответы',
            'ACTIVE' => 'Y',
            'SORT' => '500',
