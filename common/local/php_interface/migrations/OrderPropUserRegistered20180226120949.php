...
class OrderPropUserRegistered20180226120949 extends SprintMigrationBase
{
    protected $description = 'Создание свойства заказа "Оформлен зарегистрированным пользователем"';

    const PROP_CODE = 'USER_REGISTERED';
    ...
    public function up()
    {
        ...
        $addResult = OrderPropsTable::add(
            [
                'CODE'           => self::PROP_CODE,
                'NAME'           => 'Оформлен зарегистрированным пользователем',
                'TYPE'           => 'Y/N',
                'REQUIRED'       => 'N',
                'USER_PROPS'     => 'N',
                'DESCRIPTION'    => '',
