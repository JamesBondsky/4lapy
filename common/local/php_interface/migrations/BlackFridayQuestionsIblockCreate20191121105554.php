...
class BlackFridayQuestionsIblockCreate20191121105554 extends \Adv\Bitrixtools\Migration\SprintMigrationBase
{
    
    protected $description = "Инфоблок Черной Пятницы для вопросов и ответов";
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()->addIblockIfNotExists([
            ...
            'LID'                => 's1',
            'CODE'               => 'black_friday_questions',
            'NAME'               => 'Черная Пятница: Вопросы и ответы',
            'ACTIVE'             => 'Y',
            'SORT'               => '500',
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblock($helper->Iblock()->getIblockId('black_friday_questions', 'grandin'));
