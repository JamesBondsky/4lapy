...
class OrderPropStreetPrefix20180702111341 extends SprintMigrationBase {

    protected const PROP_CODE = 'STREET_PREFIX';

    protected $description = 'Добавление свойства заказа "тип улицы"';
