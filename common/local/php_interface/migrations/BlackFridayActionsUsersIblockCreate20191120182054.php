...
class BlackFridayActionsUsersIblockCreate20191120182054 extends \Adv\Bitrixtools\Migration\SprintMigrationBase
{
    
    protected $description = "Инфоблок Черной Пятницы для участников акции";
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()->addIblockIfNotExists([
            ...
            'LID'                => 's1',
            'CODE'               => 'black_friday_action_user',
            'NAME'               => 'Черная Пятница: Участники акции',
            'ACTIVE'             => 'Y',
            'SORT'               => '500',
    ...
    public function down()
    {
        ...
        $helper->Iblock()->deleteIblock($helper->Iblock()->getIblockId('black_friday_action_user', 'grandin'));
