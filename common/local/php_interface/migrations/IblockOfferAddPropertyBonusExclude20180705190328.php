...
class IblockOfferAddPropertyBonusExclude20180705190328 extends \Adv\Bitrixtools\Migration\SprintMigrationBase {

    protected $description = "Добавление свойства BONUS_EXCLUDE к ИБ предложений";
        ...
        $helper->AdminIblock()->buildElementForm($iblockId, [
            'Торговое предложение' =>
                [
                    ...
                    'PROPERTY_BONUS_EXCLUDE' => 'Не отображать баллы',
